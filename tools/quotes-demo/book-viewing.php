                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-5">
                        <div class="col form-group">
                            <input type="text" class="form-control" id="venuename" value="'. $venue_name .'" disabled>
                            <input type="hidden" id="contactname" value="'. $contact_name .'">
                        </div>
                        <div class="col form-group">
                            <div class="input-group">
                                <input type="email" class="form-control" id="emailaddress" placeholder="EMAIL ADDRESS" value="'. $email_address .'" disabled>
                                <div class="input-group-append"><div class="input-group-text"><i class="fas fa-envelope"></i></div></div>
                            </div>
                        </div>
                        <div class="col form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" id="contactnumber" placeholder="CONTACT NUMBER" value="'. $phone_number .'" disabled>
...
function bookViewing() {
    ...
    /* CHECK IF VIEWING DATE FIELD IS BLANK */
    if (viewingDate == "") {
    ...
    /* CHECK IF VIEWING TIME FIELD IS BLANK */
    if (viewingTime == "") {
