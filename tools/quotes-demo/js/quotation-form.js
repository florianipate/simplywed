...
function submitQuote(number) {
    ...
    var dataString = 'venue_number='+n+'&venue_name='+venueName+'&venue_max_daytime='+venueMaxDaytime+'&venue_max_evening='+venueMaxEvening+'&venue_max_hotel_rooms='+venueMaxHotelRooms+'&venue_hotel_room_price='+venueHotelRoomPrice+'&wedding_date='+weddingDate+'&wedding_month='+weddingMonth+'&wedding_day='+weddingDay+'&daytime_guests='+daytimeGuests+'&evening_guests='+eveningGuests+'&evening_entertain='+eveningEntertain+'&first_name='+firstName+'&last_name='+lastName+'&contact_number='+contactNumber+'&email_address='+emailAddress;
    $.ajax({
        type: "POST",
        url: "http://www.simplywed.co.uk/tools/quotes-demo/submit/get-prices.php",
        data: dataString,
        cache: false,
        error: function () {
...
function processQuote(pricing) {
    ...
    var dataString = 'venue_name='+venueName+'&venue_max_hotel_rooms='+venueMaxHotelRooms+'&venue_hotel_room_price='+venueHotelRoomPrice+'&wedding_date='+weddingDate+'&wedding_day='+weddingDay+'&daytime_guests='+daytimeGuests+'&evening_guests='+eveningGuests+'&evening_entertain='+eveningEntertain+'&first_name='+firstName+'&last_name='+lastName+'&contact_number='+contactNumber+'&email_address='+emailAddress+'&package_price='+packagePrice+'&package_guests='+packageGuests+'&daytime_price='+daytimePrice+'&evening_price='+eveningPrice+'&ext_evening_entertain='+extEveningEntertain;
    $.ajax({
        type: "POST",
        url: "http://www.simplywed.co.uk/tools/quotes-demo/submit/submit-quote.php",
        data: dataString,
        cache: false,
        complete: function (response) {
