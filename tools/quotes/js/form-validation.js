/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/* VALIDATE PRIVACY POLICY GDPR */
function valPrivacyPolicy(number) {
    
    
    /* FETCH REQUIRED DATA */
    var n = number;
    var checkBox = document.getElementById("GDPR_check-" + n);
    
    
    /* CHECK IF GDPR / PRIVACY POLICY HAS BEEN APPROVED */
    if (checkBox.checked == true) {
        
        
        /* HIGHLIGHT GDPR NOTICE IN RED */
        $("#GDPR_notice-" + n).css('color', 'black');
...
function valWeddingDate(number) {
    ...
    if (weddingDate == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-2").innerHTML = '<b>Please enter Preferred Wedding Date</b>';
        ...
        if (weddingDateObject < currentDateObject) {
            ...
            /* DISPLAY ERROR */
            document.getElementById("error-" + n + "-2").innerHTML = '<b>Please enter a Valid Date</b>';
            ...
            if (weddingDateObject < weddingBuffObject) {
                ...
                /* DISPLAY ERROR */
                document.getElementById("error-" + n + "-2").innerHTML = '<b>Your Wedding is within the next 14 Days. Please consider a later date.</b>';
                ...
                $.ajax({
                    type: "POST",
                    url: "https://www.ukweddingsavings.co.uk/tools/quotes/submit/check-date.php",
                    data: dataString,
                    cache: false,
                    error: function () {
                        ...
                        /* DISPLAY ERROR */
                        document.getElementById("error-" + n + "-2").innerHTML = '<b>Sorry, there seems to have been a problem checking date availability.</b>';
                        ...
                        if (response.responseText == "No") {
                            ...
                            /* DISPLAY ERROR */
                            document.getElementById("error-" + n + "-2").innerHTML = '<b>We are sorry, the Wedding Date you entered is not available for this venue.</b>';
...
function valDaytimeGuests(number) {
    ...
    if (daytimeGuests == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-3").innerHTML = '<b>Please enter your Daytime Guests</b>';
        ...
        if (parseInt(daytimeGuests) < parseInt(venuePackageGuests)) {
            ...
            /* DISPLAY ERROR */
            document.getElementById("error-" + n + "-3").innerHTML = '<b>Sorry, this package has a minimum requirement of ' + parseInt(venuePackageGuests) + ' Daytime Guests</b>';
            ...
            if (parseInt(daytimeGuests) > parseInt(venueMaxDaytime)) {
                ...
                /* DISPLAY ERROR */
                document.getElementById("error-" + n + "-3").innerHTML = '<b>Sorry, you have exceeded this venues max capacity of ' + parseInt(venueMaxDaytime) + ' Daytime Guests</b>';
...
function valEveningGuests(number) {
    ...
    if (eveningGuests == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-4").innerHTML = '<b>Please enter your Evening Guests</b>';
        ...
        if (parseInt(eveningGuests) < parseInt(venuePackageGuests)) {
            ...
            /* DISPLAY ERROR */
            document.getElementById("error-" + n + "-4").innerHTML = '<b>Sorry, this package has a minimum requirement of ' + parseInt(venuePackageGuests) + ' Evening Guests</b>';
            ...
            if (parseInt(eveningGuests) > parseInt(venueMaxEvening)) {
                ...
                /* DISPLAY ERROR */
                document.getElementById("error-" + n + "-4").innerHTML = '<b>Sorry, you have exceeded this venues max capacity of ' + parseInt(venueMaxEvening) + ' Evening Guests</b>';
...
function valEveningEntertain(number) {
    ...
    if (eveningEntertain == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-5").innerHTML = '<b>Do you need a DJ for your Wedding?</b>';
...
function valFirstName(number) {
    ...
    if (firstName == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-6").innerHTML = '<b>Please enter your First Name</b>';
...
function valLastName(number) {
    ...
    if (lastName == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-7").innerHTML = '<b>Please enter your Last Name</b>';
...
function valContactNumber(number) {
    ...
    if (contactNumber == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-8").innerHTML = '<b>Please enter your Contact Number</b>';
        ...
        if (phonePattern.test(contactNumber)) {
            ...
            /* DISPLAY ERROR */
            document.getElementById("error-" + n + "-8").innerHTML = '<b>Please enter a Valid Contact Number</b>';
...
function valEmailAddress(number) {
    ...
    if (emailAddress == "") {
        ...
        /* DISPLAY ERROR */
        document.getElementById("error-" + n + "-9").innerHTML = '<b>Please enter your Email Address</b>';
        ...
        if (emailPattern.test(emailAddress)) {
            ...
            /* ERASE ERROR MESSAGE */
            document.getElementById("error-" + n + "-9").innerHTML = '';
            
            
            /* SUBMIT QUOTATION */
            submitQuote(n);
            $("#quote-slide-" + n + "-9").hide();
            $("#quote-slide-" + n + "-10").show();
            ...
            /* DISPLAY ERROR */
            document.getElementById("error-" + n + "-9").innerHTML = '<b>Please enter a Valid Email Address</b>';
